<template>
  <nav class="sticky bottom-2 left-2 right-2 z-40 md:hidden bg-white/90 dark:bg-slate-900/90 backdrop-blur rounded-2xl shadow-lg border border-slate-200/50 dark:border-slate-700/50">
