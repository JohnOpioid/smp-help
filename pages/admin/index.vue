    ...
    <main class="flex-1">
      <div class="max-w-5xl mx-auto px-0 md:px-4 py-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
          <div class="bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-600 md:rounded-lg p-4">
        ...
        <div class="bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-600 md:rounded-lg mt-6">
