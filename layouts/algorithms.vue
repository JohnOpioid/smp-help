  ...
  <div :class="containerClass">
    ...
    <div class="flex-1 flex flex-col min-h-0">
      ...
      <div v-if="showTopArea" class="max-w-5xl w-full mx-auto px-4 pt-8">
        ...
        <nav v-if="showGlobalTabs" class="flex space-x-1 bg-slate-100 dark:bg-slate-800 rounded-lg p-1 w-full justify-start items-start text-left overflow-x-auto hide-scrollbar">
