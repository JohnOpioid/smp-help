...
if "$cygwin" || "$msys" ; then
    ...
    for arg do
        ...
        # so changing the positional parameters here affects neither the number of
...
fs.writeFileSync(gradlew, gradlewContent);

// Создаем gradlew.bat (Windows)
